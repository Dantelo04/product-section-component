...
export const ProductSection = () => {
    ...
    return(
        <section className="flex justify-center">
            <div className="flex flex-col justify-center items-center gap-10 xl:w-8/12">
                ...
                <div className="flex xl:flex-row flex-col gap-4">
                    ...
                    ><LuUsers className="w-6 h-auto text-primary"/>
                    </Card>
                    <Card
                    ...
                    ><BiNetworkChart className="w-6 h-auto text-primary"/>
                    </Card>
                    <Card
                    ...
                    ><PiHandCoinsBold className="w-6 h-auto text-primary"/>
                    </Card>
                </div>
            </div>
        </section>
