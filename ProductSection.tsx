        ...
        <section className="flex justify-center py-20">
            <div className="flex flex-col justify-center items-center gap-10 xl:w-8/12 px-5">
                ...
                <div className="flex xl:flex-row flex-col gap-4 w-full justify-center">
                    ...
                    ><LuUsers className="xl:w-9 w-16 h-auto text-primary"/>
                    </Card>
                    <Card
                    ...
                    ><BiNetworkChart className="xl:w-9 w-16 h-auto text-primary"/>
                    </Card>
                    <Card
                    ...
                    ><PiHandCoinsBold className="xl:w-9 w-16 h-auto text-primary"/>
                    </Card>
                </div>
            </div>
        </section>
